...
- Updatable data sources are acquired at specified intervals – quarterly, or as needed. - As new static data sources are discovered, they will be integrated into the proposed compendium. 
    - Data will be processed using dataset‐specific VBA programs. Program file
...
the entire geodatabase. ^[The FGDC standard was chosen due to required Federal government standards.]
...
1. The database will be preserved in
...
software programs. 
    a. The data manager at the NMISC will be responsible for
the management of long-term 
    a. storage and archived data.
    a. And this one will be c!
